...
public class HomeworkTask3 {
    public static void main(String[] args) {
        /*
        Homework 3: Write a program that reads a range of integers
        ...
        for (int i = start; i <=end ; i++) {
            if (i%2==0){
                evenSum+=i; // can also be written evenSum=evenSum+i
            }else{
                oddSum=oddSum+i; // same thing as oddSum+=i
            }
        }
        System.out.println("Sum of all the even numbers "+evenSum);
        System.out.println("Sum od all the odd numbers "+oddSum);
